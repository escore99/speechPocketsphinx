...
#define SWIGTYPE_p_p_p_mfcc_t swig_types[14]
...
SWIGINTERN FrontEnd *new_FrontEnd(void){
	return NULL;
    }
...
SWIGINTERN int FrontEnd_process_utt(FrontEnd *self,char *spch,size_t nsamps,mfcc_t ***cep_block){
        int nframes;
...
SWIGINTERN FsgModel *new_FsgModel__SWIG_0(char const *name,LogMath *logmath,float lw,int n){
	return fsg_model_init(name, logmath, lw, n);
    }
SWIGINTERN FsgModel *new_FsgModel__SWIG_1(char const *path,LogMath *logmath,float lw){
...
SWIGINTERN void FsgModel_trans_add(FsgModel *self,int src,int dst,int logp,int wid){
        fsg_model_trans_add(self, src, dst, logp, wid);
    }
SWIGINTERN int FsgModel_null_trans_add(FsgModel *self,int src,int dst,int logp){
        return fsg_model_null_trans_add(self, src, dst, logp);
    }
SWIGINTERN int FsgModel_tag_trans_add(FsgModel *self,int src,int dst,int logp,int wid){
        return fsg_model_tag_trans_add(self, src, dst, logp, wid);
    }
SWIGINTERN int FsgModel_add_silence(FsgModel *self,char const *silword,int state,float silprob){
...
SWIGINTERN JsgfRule *JsgfRule_fromIter(void *itor){
    return jsgf_rule_iter_rule((jsgf_rule_iter_t *)itor);
  }
SWIGINTERN char const *JsgfRule_get_name(JsgfRule *self){
    return jsgf_rule_name(self);
  }
SWIGINTERN bool JsgfRule_is_public(JsgfRule *self){
    return jsgf_rule_public(self);
  }
SWIGINTERN NGramModel *NGramModel_fromIter(void *itor){
        const char *name;
...
SWIGINTERN void NGramModel_write(NGramModel *self,char const *path,int ftype,int *errcode){
        *errcode = ngram_model_write(self, path, (ngram_file_type_t)ftype);
    }
SWIGINTERN int NGramModel_str_to_type(NGramModel *self,char const *str){
...
SWIGINTERN int NGramModel_size(NGramModel *self){
        return ngram_model_get_size(self);
    }
SWIGINTERN int NGramModel_add_word(NGramModel *self,char const *word,float weight){
        return ngram_model_add_word(self, word, weight);
    }
SWIGINTERN int NGramModel_prob(NGramModel *self,size_t n,char **ptr){
        return ngram_prob(self, (const char * const *)ptr, n);
    }
SWIGINTERN LogMath *new_LogMath(void){
	return logmath_init(1.0001f, 0, 0);
    }
SWIGINTERN void delete_LogMath(LogMath *self){
        logmath_free(self);
    }
SWIGINTERN double LogMath_exp(LogMath *self,int prob){
        return logmath_exp(self, prob);
    }
SWIGINTERN NGramModelSetIterator *new_NGramModelSetIterator(void *ptr){
    NGramModelSetIterator *iter = (NGramModelSetIterator *)ckd_malloc(sizeof *iter);
    iter->ptr = (ngram_model_set_iter_t *)ptr;
    return iter;
  }
...
SWIGINTERN JsgfIterator *new_JsgfIterator(void *ptr){
    JsgfIterator *iter = (JsgfIterator *)ckd_malloc(sizeof *iter);
    iter->ptr = (jsgf_rule_iter_t *)ptr;
    return iter;
  }
...
SWIGINTERN int NGramModelSet_count(NGramModelSet *self){
...
SWIGINTERN char const *Jsgf_get_name(Jsgf *self){
...
SWIGINTERN PyObject *_wrap_new_FrontEnd(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":new_FrontEnd")) SWIG_fail;
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (FrontEnd *)new_FrontEnd();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_FrontEnd_process_utt(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res2 = SWIG_AsCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "FrontEnd_process_utt" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = (char *)(buf2);
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)FrontEnd_process_utt(arg1,arg2,arg3,arg4);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
...
SWIGINTERN PyObject *_wrap_new_Feature(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":new_Feature")) SWIG_fail;
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (Feature *)calloc(1, sizeof(Feature));
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_new_FsgModel__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "new_FsgModel" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_new_FsgModel__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (FsgModel *)new_FsgModel__SWIG_1((char const *)arg1,arg2,arg3);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_FsgModel, SWIG_POINTER_NEW |  0 );
  if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_FsgModel'.\n"
    ...
    "    FsgModel::FsgModel(char const *,LogMath *,float,int)\n"
...
SWIGINTERN PyObject *_wrap_FsgModel_trans_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "FsgModel_trans_add" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "FsgModel_trans_add" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "FsgModel_trans_add" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ecode5 = SWIG_AsVal_int(obj4, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "FsgModel_trans_add" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = (int)(val5);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_FsgModel_null_trans_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "FsgModel_null_trans_add" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "FsgModel_null_trans_add" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "FsgModel_null_trans_add" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)FsgModel_null_trans_add(arg1,arg2,arg3,arg4);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_FsgModel_tag_trans_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "FsgModel_tag_trans_add" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "FsgModel_tag_trans_add" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "FsgModel_tag_trans_add" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ecode5 = SWIG_AsVal_int(obj4, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "FsgModel_tag_trans_add" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = (int)(val5);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)FsgModel_tag_trans_add(arg1,arg2,arg3,arg4,arg5);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_FsgModel_add_silence(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "FsgModel_add_silence" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
...
SWIGINTERN PyObject *_wrap_JsgfRule_fromIter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "JsgfRule_fromIter" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_JsgfRule_get_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:JsgfRule_get_name",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_JsgfRule, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "JsgfRule_get_name" "', argument " "1"" of type '" "JsgfRule *""'"); 
  }
  arg1 = (JsgfRule *)(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (char *)JsgfRule_get_name(arg1);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_FromCharPtr((const char *)result);
  return resultobj;
...
SWIGINTERN PyObject *_wrap_JsgfRule_is_public(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  JsgfRule *arg1 = (JsgfRule *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:JsgfRule_is_public",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_JsgfRule, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "JsgfRule_is_public" "', argument " "1"" of type '" "JsgfRule *""'"); 
  }
  arg1 = (JsgfRule *)(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (bool)JsgfRule_is_public(arg1);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_bool((bool)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_NGramModel_fromIter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0,SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NGramModel_fromIter" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_NGramModel_write(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "NGramModel_write" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_NGramModel_str_to_type(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)NGramModel_str_to_type(arg1,(char const *)arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
...
SWIGINTERN PyObject *_wrap_NGramModel_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)NGramModel_size(arg1);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_NGramModel_add_word(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode3 = SWIG_AsVal_float(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "NGramModel_add_word" "', argument " "3"" of type '" "float""'");
  } 
  arg3 = (float)(val3);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)NGramModel_add_word(arg1,(char const *)arg2,arg3);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
...
SWIGINTERN PyObject *_wrap_NGramModel_prob(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)NGramModel_prob(arg1,arg2,arg3);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  {
...
SWIGINTERN PyObject *_wrap_new_LogMath(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  LogMath *result = 0 ;
...
SWIGINTERN PyObject *_wrap_LogMath_exp(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)LogMath_exp(arg1,arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double((double)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_new_NGramModelSetIterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0,SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_NGramModelSetIterator" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_new_JsgfIterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0,SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_JsgfIterator" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_NGramModelSet_count(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)NGramModelSet_count(arg1);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_Jsgf_get_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Jsgf *arg1 = (Jsgf *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Jsgf_get_name",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Jsgf, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Jsgf_get_name" "', argument " "1"" of type '" "Jsgf *""'"); 
  }
  arg1 = (Jsgf *)(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (char *)Jsgf_get_name(arg1);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_FromCharPtr((const char *)result);
  return resultobj;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_FrontEnd", _wrap_new_FrontEnd, METH_VARARGS, (char *)"new_FrontEnd() -> FrontEnd"},
	 ...
	 { (char *)"FrontEnd_process_utt", _wrap_FrontEnd_process_utt, METH_VARARGS, (char *)"FrontEnd_process_utt(FrontEnd self, char * spch, size_t nsamps, mfcc_t *** cep_block) -> int"},
	 ...
	 { (char *)"new_Feature", _wrap_new_Feature, METH_VARARGS, (char *)"new_Feature() -> Feature"},
	 { (char *)"Feature_swigregister", Feature_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_FsgModel", _wrap_new_FsgModel, METH_VARARGS, (char *)"\n"
		"FsgModel(char const * name, LogMath logmath, float lw, int n)\n"
	 ...
	 { (char *)"FsgModel_trans_add", _wrap_FsgModel_trans_add, METH_VARARGS, (char *)"FsgModel_trans_add(FsgModel self, int src, int dst, int logp, int wid)"},
	 { (char *)"FsgModel_null_trans_add", _wrap_FsgModel_null_trans_add, METH_VARARGS, (char *)"FsgModel_null_trans_add(FsgModel self, int src, int dst, int logp) -> int"},
	 { (char *)"FsgModel_tag_trans_add", _wrap_FsgModel_tag_trans_add, METH_VARARGS, (char *)"FsgModel_tag_trans_add(FsgModel self, int src, int dst, int logp, int wid) -> int"},
	 { (char *)"FsgModel_add_silence", _wrap_FsgModel_add_silence, METH_VARARGS, (char *)"FsgModel_add_silence(FsgModel self, char const * silword, int state, float silprob) -> int"},
	 ...
	 { (char *)"JsgfRule_fromIter", _wrap_JsgfRule_fromIter, METH_VARARGS, (char *)"JsgfRule_fromIter(void * itor) -> JsgfRule"},
	 { (char *)"JsgfRule_get_name", _wrap_JsgfRule_get_name, METH_VARARGS, (char *)"JsgfRule_get_name(JsgfRule self) -> char const *"},
	 { (char *)"JsgfRule_is_public", _wrap_JsgfRule_is_public, METH_VARARGS, (char *)"JsgfRule_is_public(JsgfRule self) -> bool"},
	 ...
	 { (char *)"NGramModel_fromIter", _wrap_NGramModel_fromIter, METH_VARARGS, (char *)"NGramModel_fromIter(void * itor) -> NGramModel"},
	 ...
	 { (char *)"NGramModel_write", _wrap_NGramModel_write, METH_VARARGS, (char *)"NGramModel_write(NGramModel self, char const * path, int ftype)"},
	 { (char *)"NGramModel_str_to_type", _wrap_NGramModel_str_to_type, METH_VARARGS, (char *)"NGramModel_str_to_type(NGramModel self, char const * str) -> int"},
	 ...
	 { (char *)"NGramModel_size", _wrap_NGramModel_size, METH_VARARGS, (char *)"NGramModel_size(NGramModel self) -> int"},
	 { (char *)"NGramModel_add_word", _wrap_NGramModel_add_word, METH_VARARGS, (char *)"NGramModel_add_word(NGramModel self, char const * word, float weight) -> int"},
	 { (char *)"NGramModel_prob", _wrap_NGramModel_prob, METH_VARARGS, (char *)"NGramModel_prob(NGramModel self, size_t n) -> int"},
	 { (char *)"NGramModel_swigregister", NGramModel_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_LogMath", _wrap_new_LogMath, METH_VARARGS, (char *)"new_LogMath() -> LogMath"},
	 { (char *)"delete_LogMath", _wrap_delete_LogMath, METH_VARARGS, (char *)"delete_LogMath(LogMath self)"},
	 { (char *)"LogMath_exp", _wrap_LogMath_exp, METH_VARARGS, (char *)"LogMath_exp(LogMath self, int prob) -> double"},
	 { (char *)"LogMath_swigregister", LogMath_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_NGramModelSetIterator", _wrap_new_NGramModelSetIterator, METH_VARARGS, (char *)"new_NGramModelSetIterator(void * ptr) -> NGramModelSetIterator"},
	 ...
	 { (char *)"new_JsgfIterator", _wrap_new_JsgfIterator, METH_VARARGS, (char *)"new_JsgfIterator(void * ptr) -> JsgfIterator"},
	 ...
	 { (char *)"NGramModelSet_count", _wrap_NGramModelSet_count, METH_VARARGS, (char *)"NGramModelSet_count(NGramModelSet self) -> int"},
	 ...
	 { (char *)"Jsgf_get_name", _wrap_Jsgf_get_name, METH_VARARGS, (char *)"Jsgf_get_name(Jsgf self) -> char const *"},
